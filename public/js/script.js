...
let questions = [
    new Question ("ma question 1", ["reponse 1" , "reponse 2", "reponse 3", "reponse 4"], "reponse 1"),
    new Question ("ma question 2", ["reponse 1" , "reponse 2", "reponse 3", "reponse 4"], "reponse 2"),
    new Question ("ma question 3", ["reponse 1" , "reponse 2", "reponse 3", "reponse 4"], "reponse 3"),
    new Question ("ma question 4", ["reponse 1" , "reponse 2", "reponse 3", "reponse 4"], "reponse 4"),
];
...
//regroupe les fonctions relative à l'affichage
const display = {
    elementShown: function(id, text) {
        let element = document.getElementById(id);
        element.innerHTML = text;
...
quizApp = () => {
    if(quiz.hasEnded()){
        // on affiche que le jeu est fini
        display.endQuiz;
    } else {    
        // on affiche la question suivante
        display.question();
        // on affiche les choix de la question
        display.choices();
